...
function setup() {
  ...
  input.position(width/2-285, 100);
  input.size(420,50);


  button = createButton('Post');
  button.position(width/2-340,169);
...
class post{
  ...
  show1 (){
    image(img, width/4-25, this.y, 490, 180);
    fill (50,50,50);
    textSize (20);
...
class notification1{
  ...
  show(){
    ...
    text ('You'+' liked a post after looking at it for ' + floor(random(4,12)) + ' seconds.', width/6-150, this.y+1020, 200);
  }
}
